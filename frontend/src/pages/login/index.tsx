					...
					<Col xs={0} sm={0} lg={12}>
						<Space direction="vertical">
							<Space>
								...
								<h1 className={classes.logoText}>Aplikasi Bank Sampah</h1>
							</Space>
							<img
					...
					<Col xs={24} sm={24} lg={12}>
						...
						>
							<Space direction="vertical" style={{ minWidth: "80%" }}>
								<Space direction="vertical">
									<div className={classes.hello}>Halaman Login</div>
									<Space className={classes.loginLogoText}>Admin Panel</Space>
								</Space>
